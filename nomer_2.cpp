...
namespace ext
{
	enum class Month { January = 1, February, March, April, May, June, July, August, September, October, Novemver, December };
	enum DateFormat { MonthAsInt, MonthAsString };
	enum Season { Winter, Spring, Summer, Autumn };
	struct Date { int year; Month month; int day; };
	struct TimeDelta { int delta; };
	...
	void print(TimeDelta delta) { cout << delta.delta; }
	...
	Season getSeason(Month month){
		...
		case 1:
		case 2:
		case 12: return Season::Winter; break;
		case 3:
		case 4:
		case 5: return Season::Spring; break;
		case 6:
		case 7:
		case 8: return Season::Summer; break;
		case 9:
		case 10:
		case 11: return Season::Autumn; break;
		}
	}
	...
	Date ToDate(TimeDelta delta) {
		...
		int d = (4 * c + 3) / 1461;
		int e = c - 1461 * d / 4;
		xx.day = e - ((153 * (5 * e + 2) / 153 + 2) / 5) + 1;
		xx.month = static_cast<Month>(((5 * e + 2) / 153) + 3 - (12 * (5 * e + 2) / 1530));
		xx.year = 100 * b + d - 4800 + (5 * e + 2) / 1530;
		return xx;
	}
